...
const SettingsSidebar = () => {
	...
	/** @edit-custom-post-type **/
	const DocumentSettingSidebar = useSelect( select => {
		return select( editCustomPostTypeStore ).getDocumentSettingSidebar();
	} );

	/** @edit-custom-post-type **/
	const DocumentSidebarContent = () => {
		return DocumentSettingSidebar ? <DocumentSettingSidebar/>
		: <>
			<PostStatus />
			<Template />
